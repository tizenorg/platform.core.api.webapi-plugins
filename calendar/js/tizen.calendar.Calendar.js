...
(function () {
    ...
    var _item = require('./tizen.calendar.CalendarItem');
    var CalendarItem = _item.CalendarItem;
    var CalendarTask = _item.CalendarTask;
    var CalendarEvent = _item.CalendarEvent;
    var CalendarEventId = _item.CalendarEventId;
    var T = _common.Type;
