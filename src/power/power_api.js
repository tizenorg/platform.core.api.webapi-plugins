...
PowerManager.prototype.request = function(resource, state) {
    ...
    if (args['state'] && args.state === PowerScreenState['SCREEN_BRIGHT']) {
        console.warn('DEPRECATION WARNING: SCREEN_BRIGHT is deprecated since Tizen 2.1.');
    }
...
PowerManager.prototype.turnScreenOn = function() {
	console.warn('DEPRECATION WARNING: turnScreenOn is deprecated since Tizen 2.4.');
...
PowerManager.prototype.turnScreenOff = function() {
	console.warn('DEPRECATION WARNING: turnScreenOff is deprecated since Tizen 2.4.');
