...
const std::string GDBusWrapper::DEFAULT_OBJECT_PATH = "/Org/Tizen/System/DeviceD/Display";
...
bool GDBusWrapper::Connect(){
    ...
    proxy_ = _auto_gen_org_tizen_system_deviced_display_proxy_new_for_bus_sync( bus_type_,
                                                                                bus_proxy_flags_,
                                                                                bus_name_.c_str(),
                                                                                object_path_.c_str(),
                                                                                NULL,
...
bool GDBusWrapper::CurrentBrightness(int *result){
    ...
    GError *error_ = nullptr;
    gint out_result;
    gboolean ret = _auto_gen_org_tizen_system_deviced_display_call_current_brightness_sync (proxy_,
                                                                                            &out_result,
                                                                                            NULL,
                                                                                            &error_);
    if(ret == false){
...
bool GDBusWrapper::CustomBrightness(int *result){
    ...
    GError *error_ = nullptr;
    gint out_result;
    gboolean ret = _auto_gen_org_tizen_system_deviced_display_call_custom_brightness_sync (proxy_,
                                                                                            &out_result,
                                                                                            NULL,
                                                                                            &error_);
    if(ret == false){
...
bool GDBusWrapper::HoldBrightness(const int brightness, int *result){
    ...
    gboolean ret = _auto_gen_org_tizen_system_deviced_display_call_hold_brightness_sync(proxy_,
                                                                                        in_brightness,
                                                                                        &out_result,
                                                                                        NULL,
                                                                                        &error_);
...
bool GDBusWrapper::LockState(const std::string state,
    ...
    gint out_result;
    gboolean ret = _auto_gen_org_tizen_system_deviced_display_call_lock_state_sync(proxy_,
                                                                                   arg_state,
                                                                                   arg_option1,
                                                                                   arg_option2,
                                                                                   _timeout,
...
bool GDBusWrapper::ReleaseBrightness(int *result){
    ...
    GError *error_ = nullptr;
    gint out_result;
    gboolean ret = _auto_gen_org_tizen_system_deviced_display_call_release_brightness_sync(proxy_,
                                                                                        &out_result,
                                                                                        NULL,
                                                                                        &error_);
    if(ret == false){
...
bool GDBusWrapper::UnlockState(const std::string state,
    ...
    gboolean ret = _auto_gen_org_tizen_system_deviced_display_call_unlock_state_sync(proxy_,
                                                                                     arg_state,
                                                                                     arg_option,
                                                                                     &out_result,
                                                                                     NULL,
