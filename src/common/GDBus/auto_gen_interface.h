...
void _auto_gen_org_tizen_system_deviced_display_complete_lock_state (
    _auto_genOrgTizenSystemDevicedDisplay *object,
    GDBusMethodInvocation *invocation,
    gint result);

void _auto_gen_org_tizen_system_deviced_display_complete_unlock_state (
    _auto_genOrgTizenSystemDevicedDisplay *object,
    GDBusMethodInvocation *invocation,
    gint result);
...
/* D-Bus method calls: */
void _auto_gen_org_tizen_system_deviced_display_call_lock_state (
...
gboolean _auto_gen_org_tizen_system_deviced_display_call_lock_state_finish (
    _auto_genOrgTizenSystemDevicedDisplay *proxy,
    gint *out_result,
    GAsyncResult *res,
    GError **error);

gboolean _auto_gen_org_tizen_system_deviced_display_call_lock_state_sync (
    _auto_genOrgTizenSystemDevicedDisplay *proxy,
    const gchar *arg_state,
    const gchar *arg_option1,
    const gchar *arg_option2,
...
void _auto_gen_org_tizen_system_deviced_display_call_unlock_state (
    _auto_genOrgTizenSystemDevicedDisplay *proxy,
    const gchar *arg_state,
    const gchar *arg_option,
    GCancellable *cancellable,
...
gboolean _auto_gen_org_tizen_system_deviced_display_call_unlock_state_finish (
    _auto_genOrgTizenSystemDevicedDisplay *proxy,
    gint *out_result,
    GAsyncResult *res,
    GError **error);

gboolean _auto_gen_org_tizen_system_deviced_display_call_unlock_state_sync (
    _auto_genOrgTizenSystemDevicedDisplay *proxy,
    const gchar *arg_state,
    const gchar *arg_option,
    gint *out_result,
