...
void CalendarManager::GetCalendars(const json::Object& args, json::Object& out) {
    LoggerD("enter");
    ...
    auto get = [type](const std::shared_ptr<json::Value>& response) -> void {
        ...
        try {
            ...
            while (count-- > 0) {
                ...
                store_type = CalendarRecord::GetInt(calendar, _calendar_book.store_type);
                ...
                CalendarRecord::CalendarToJson(calendar, &array.back().get<json::Object>());
...
void CalendarManager::GetCalendar(const json::Object& args, json::Object& out) {
    ...
    CalendarRecordPtr record_ptr = CalendarRecord::GetById(id, _calendar_book._uri);

    int type = CalendarRecord::TypeToInt(FromJson<std::string>(args, "type"));
    int calendar_type = CalendarRecord::GetInt(record_ptr.get(), _calendar_book.store_type);
...
void CalendarManager::RemoveCalendar(const json::Object& args, json::Object& out) {
    LoggerD("enter");
