...
(function () {
    ...
    _common = undefined;
    var _calendarCommon = require('./tizen.calendar.Common');
    var _edit = _calendarCommon._edit;
    var _itemConverter = _calendarCommon._itemConverter;
    var _recurrenceManager = _calendarCommon._recurrenceManager;
    _calendarCommon = undefined;
        ...
        Object.defineProperties(this, {
            ...
            status: {
                ...
                set: function (v) {
                    ...
                    if (this instanceof tizen.CalendarEvent) {
                        _status = v
                            ? Converter.toEnum(v, Object.keys(CalendarItemStatus).slice(0, 3), false)
                            : CalendarItemStatus.CONFIRMED;
                    } else {
                        _status = v
                            ? Converter.toEnum(v, Object.keys(CalendarItemStatus).slice(2), false)
            ...
            priority: {
                ...
                set: function (v) {
                    ...
                    _priority = v
                        ? Converter.toEnum(v, Object.keys(CalendarItemPriority), false)
                        : _status;
                },
                enumerable: true
            },
