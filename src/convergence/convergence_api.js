...
function Service(serviceType) {
  ...
  Object.defineProperties(this, {
    _isLocal : {value: false, writable: true, enumerable: false},         // Indicates if the service is managed by D2D Conv Mgr as a local service
...
Service.prototype.connect = function(successCallback, errorCallback) {
  ...
  if(this._isLocal && !this._isLocalyHandled)
