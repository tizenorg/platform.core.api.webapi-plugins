...
void ConvergenceManager::ServiceForeachCb(conv_service_h service_handle,
  ...
  // TODO: fix me | seems this native API is not implemented yet
  //conv_service_get_connection_state(service_handle, &state);
  state = CONV_SERVICE_CONNECTION_STATE_CONNECTED;
...
void ConvergenceManager::FindServiceCb(conv_service_h service_handle, void*
  user_data) {
